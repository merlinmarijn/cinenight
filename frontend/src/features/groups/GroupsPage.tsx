...
export default function GroupsPage({ user }: { user: UserDto }) {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    type="button"
                    disabled={!user.canCreateGroups}
                    onClick={() => setIsCreateModalOpen(true)}
                    className="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 font-semibold text-white shadow-lg shadow-indigo-500/20 transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:bg-gray-700 disabled:text-gray-400 disabled:shadow-none disabled:hover:bg-gray-700"
                >
            ...
            {/* Modal */}
            {isCreateModalOpen && user.canCreateGroups && (
                <CreateGroupModal
